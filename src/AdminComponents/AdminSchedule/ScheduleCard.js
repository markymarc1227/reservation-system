...
export const CustomerCard = ({ user_id, req_id, name, reqtime, service, barber, onCompleteCustomer}) => {
    ...
    return(
      <div className="wrapper tc mh3 mv1 ba br3 bw1 f5 pa1 black bg-white b--black">
        ...
        <div className="flex flex-wrap center justify-around">
          ...
          <button onClick={onCompleteCustomer} value={req_id} className="ba br2 bw1 pv0 ph2 mv1 mh3 red bg-white b--red grow pointer">&#10006;</button>
        </div>
    </div>
    );
  };